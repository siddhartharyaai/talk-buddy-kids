      ...
      <div className="w-full max-w-md space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 text-sm text-green-800">
                ...
                <ul className="space-y-1 text-xs">
                  <li>• Child profiles are encrypted and secure</li>
                  <li>• Conversations are not saved or stored</li>
                  <li>• Data never leaves your secure account</li>
                  <li>• No tracking or data sharing with third parties</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <div className="text-center text-xs text-gray-500 space-y-1">
          <div className="flex items-center justify-center gap-1">
            ...
            <span>End-to-end encrypted • COPPA compliant</span>
          </div>
          <p>Made with ❤️ for families who value safe, educational AI</p>
        </div>
      </div>
    </div>
  );
